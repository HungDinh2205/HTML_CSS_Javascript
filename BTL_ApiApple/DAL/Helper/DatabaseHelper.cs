...
namespace DAL
{
    public class DatabaseHelper : IDatabaseHelper
    {
        ...
        public bool ExecuteScalarSProcedureWithTransaction(out string msgError, string v1, string v2, int maHoaDon, string v3, decimal tongHoaDon, string v4, int soLuong, string v5, object maTaiKhoan, string v6, int maSanPham, string v7, object diachi, string v8, int sDT)
        {
